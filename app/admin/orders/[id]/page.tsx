...
export const metadata: Metadata = { title: "处理订单" };
    ...
    <section className="px-5 py-12 sm:px-8 lg:px-12">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-6 rounded-[2rem] bg-stone-950 p-7 text-white sm:p-9">
          ...
          <h1 className="mt-4 text-3xl font-semibold tracking-[-0.04em]">处理订单</h1>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[minmax(0,1fr)_22rem]">
          <div className="space-y-6">
            <div className="rounded-3xl border border-stone-200 bg-white p-6">
              <h2 className="text-xl font-semibold text-stone-950">配送进度</h2>
              <div className="mt-6">
            ...
            <div className="rounded-3xl border border-stone-200 bg-white p-6">
              <div className="flex justify-between">
                <h2 className="text-xl font-semibold">商品明细</h2>
          ...
          <aside className="space-y-6">
            <div className="rounded-3xl border border-stone-200 bg-white p-6">
              ...
              <p className="mt-4 text-sm font-semibold">{order.customer?.name ?? "账户已删除"}</p>
              <p className="mt-1 text-xs break-all text-stone-500">
                {order.customer?.email ?? "—"}
              </p>
            </div>
            <div className="rounded-3xl border border-stone-200 bg-white p-6">
              <h2 className="text-lg font-semibold">配送地址</h2>
            ...
            <div className="rounded-3xl border border-stone-200 bg-white p-6">
              ...
              <p className="mt-4 text-sm text-stone-600">
                方式：{order.paymentMethod === "stripe" ? "Stripe" : "货到付款"}
              </p>
