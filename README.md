...
npm test              # 运行模型、认证、商品、搜索、购物车、结算、支付、订单、账户、管理员、统计、UI、错误处理、安全与性能测试
